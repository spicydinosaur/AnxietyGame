...
public class PillarObjectInteraction : ObjectInteraction
{
    ...
    public void Start()
    {
        ...
        colliderDirection = PillarObjectInteraction.ColliderDirection.inactive;
    ...
    public override void InteractWithObject()
    {
        ...
        if (playerTouchingObject && !puzzleComplete)
        {
            ...
            if (colliderDirection == PillarObjectInteraction.ColliderDirection.north)
            {
            ...
            else if (colliderDirection == PillarObjectInteraction.ColliderDirection.south)
            {
                //object can move north
                moveIncrementVector = new Vector3(0, moveIncrementVectorFloat);
                direction = Vector2.up;
            }
            else if (colliderDirection == PillarObjectInteraction.ColliderDirection.east)
            {
                //object can move east
                moveIncrementVector = new Vector3(-moveIncrementVectorFloat, 0);
                direction = Vector2.left;
            }
            else if (colliderDirection == PillarObjectInteraction.ColliderDirection.west)
            {
